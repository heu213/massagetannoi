...
declare module 'sub-vn' {
  ...
  export function getProvinceByAreaCode(code: string): any;
  ...
  export function getCodeByDistrict(nameDistrict: string, nameCity: string): any;
  export function getCodeByWard(name: string, nameCity: string): any;
  export function getCodeProvince(name: string): any;
}
...
declare module 'mongoose' {
  ...
  // statics
  interface MongooseIntlModel<T extends Document, QueryHelpers = {}> extends Model<T, QueryHelpers> {
    getLanguages(): [string];
...
declare module 'mongoose' {
  ...
  // interface PaginateModel<T extends Document, DocumentQuery = {}> extends Model<T, DocumentQuery> {
  //     paginate(
  //       query?: FilterQuery<T>,
  //       options?: PaginateOptions,
